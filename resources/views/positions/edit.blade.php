                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-4 py-4">
                    ...
                    <form method="POST" action="{{ route('positions.update', $position) }}">
                        ...
                        <div hidden>
                            ...
                            <x-input id="user_id" class="block mt-1 w-full" type="text" name="user_id" :value="$position->user_id" required autofocus autocomplete="user_id" value="9999" />
                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            url: "{{ route('getMunicipality') }}?federal_entity_id="+municipio,
            type: 'get',
            success: function (res) {
