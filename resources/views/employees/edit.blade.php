                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-4 py-4">
                    ...
                    <form method="POST" action="{{ route('employees.update', $employee) }}">
                        ...
                        <div hidden>
                            ...
                            <x-input id="key" class="block mt-1 w-full" type="text" name="key" value="{{$employee->key}}" disabled autofocus autocomplete="key" />
                        </div>
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div class="relative max-w-sm">
                                ...
                                <x-input id="date_birth" name="date_birth" x-data x-init="flatpickr($refs.input, {{ $options }} );" x-ref="input" type="text" data-input class='block mt-1 w-full pl-10 p-2.5' value="{{$personal_data->date_birth}}"/>
                            </div>

                            <div>
                                <x-label for="nss" value="{{ __('NSS') }}:" />
                                <x-input id="nss" class="block mt-1 w-full" maxlength="10" type="text" name="nss" value="{{$personal_data->nss}}" autofocus autocomplete="nss" />
                            </div>
                            
                            <div>
                                <x-label for="rfc" value="{{ __('RFC') }}:" />
                                <x-input id="rfc" class="block mt-1 w-full" oninput="this.value = this.value.toUpperCase()" maxlength="15" type="text" name="rfc" value="{{$personal_data->rfc}}" required autofocus autocomplete="rfc" />
                            </div>

                            <div>
                                <x-label for="curp" value="{{ __('CURP') }}:" />
                                <x-input id="curp" class="block mt-1 w-full" oninput="this.value = this.value.toUpperCase()" maxlength="20" type="text" name="curp" value="{{$personal_data->curp}}" required autofocus autocomplete="curp" />
                            </div>
                            ...
                            <div>
                                ...
                                @if($personal_data->gender == 1)
                                    <div class="flex items-center mb-4">
                                        <input checked id="default-radio-1" type="radio" value="1" name="gender" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-white dark:border-gray-600">
                                    ...
                                    <div class="flex items-center mb-4">
                                        <input id="default-radio-3" type="radio" value="3" name="gender" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-white dark:border-gray-600">
                                        <label for="default-radio-3" class="ms-2 text-sm font-medium text-gray-900 dark:text-black-300">Otro.</label>
                                    </div>
                                @elseif($personal_data->gender == 2)
                                    <div class="flex items-center mb-4">
                                    ...
                                    <div class="flex items-center mb-4">
                                        <input checked id="default-radio-2" type="radio" value="2" name="gender" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-white dark:border-gray-600">
                                        <label for="default-radio-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-black-300">Femenino.</label>
                                    </div>
                                    <div class="flex items-center mb-4">
                                        <input id="default-radio-3" type="radio" value="3" name="gender" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-white dark:border-gray-600">
                            ...
                            <div>
                                ...
                                <select id="level_schooling" name="level_schooling" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                    ...
                                    @foreach($escolaridad as $nivel)
                                        @if($personal_data->level_schooling == $nivel)
                            ...
                            <div>
                                ...
                                <x-input id="voter_identification" class="block mt-1 w-full" maxlength="20" type="text" name="voter_identification" value="{{$personal_data->voter_identification}}"  autofocus autocomplete="voter_identification" />
                            </div>
                            ...
                            <div>
                                ...
                                <select id="type_blood_id" name="type_blood_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                    ...
                                    @foreach($type_bloods as $blood)
                                        @if($personal_data->type_blood_id == $blood->type_blood_id)
                                            <option value="{{$blood->type_blood_id}}" selected>{{$blood->key}}</option>
                                        @else
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                ...
                                <x-input required id="street" class="block mt-1 w-full" maxlength="45" type="text" name="street" value="{{$contact_information->street}}"  autofocus autocomplete="street" />
                            </div>

                            <div>
                                <x-label for="number" value="{{ __('Número') }}:" />
                                <x-input required id="number" class="block mt-1 w-full" maxlength="5" type="text" name="number" value="{{$contact_information->number}}"  autofocus autocomplete="number" />
                            </div>
                                
                            <div>
                                <x-label for="zip_code" value="{{ __('Código postal') }}:" />
                                <x-input required id="zip_code" class="block mt-1 w-full" maxlength="5" type="text" name="zip_code" value="{{$contact_information->zip_code}}"  autofocus autocomplete="zip_code" />
                            </div>
                            <div>
                                <x-label for="phone" value="{{ __('Teléfono') }}:" />
                                <x-input type="tel" id="phone" class="block mt-1 w-full" maxlength="15" name="phone" value="{{$contact_information->phone}}"  autofocus autocomplete="phone" placeholder="(123)-456-7890" onkeyup="handlePhone(event)" required />
                            </div>
                            <div class="mb-6">
                                <x-label for="email" value="{{ __('Correo electrónico') }}:" />
                                <input type="email" id="email" name="email" value="{{$contact_information->email}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="john.doe@company.com" required>
                            </div> 
                        </div>
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div id="estados">
                                ...
                                <select name="state" id="state" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                    ...
                                    @foreach ($federal_entity as $states)
                                        @if($federalEntity[0]->federal_entity_id == $states->federal_entity_id)
                                            <option value="{{$states->federal_entity_id}}" selected>{{$states->name}}</option>
                                        @else
                            ...
                            <div id="municipios">
                                ...
                                <select name="municipality" id="municipality" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                    <option value="{{$municipality_data[0]->municipality_id}}&{{$municipality_data[0]->federal_entity_id}}&{{$municipality_data[0]->name}}" selected disabled>{{$municipality_data[0]->name}}</option>
                                </select>
                                <br>
                            </div>
                            ...
                            <div id="localidades">
                                ...
                                <select name="location_id" id="location_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                    <option value="{{$location_data[0]->location_id}}&{{$location_data[0]->municipality_id}}&{{$location_data[0]->name}}" selected>{{$location_data[0]->name}}</option>
                                </select>
                            </div>
                        </div>
